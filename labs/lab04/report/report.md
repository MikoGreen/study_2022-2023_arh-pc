...
Внутритекстовые формулы делаются аналогично формулам LaTeX. Например, формула  запишется как
$\sin^2 (x) + \cos^2 (x) = 1$.
...
![Рис. 13 Перейдем в каталог с шаблоном отчета по лаб. pаботе №4](/home/narogozhina/Изображения/Лабораторная работа №4/13.png){ #fig:013 width=70% }
...
![](/home/narogozhina/Изображения/Лабораторная работа №4/15.png){ #fig:015 width=70% }

![](/home/narogozhina/Изображения/Лабораторная работа №4/16.png){ #fig:016 width=70% }

![](/home/narogozhina/Изображения/Лабораторная работа №4/17.png){ #fig:017 width=70% }

![](/home/narogozhina/Изображения/Лабораторная работа №4/18.png){ #fig:018 width=70% }

![](/home/narogozhina/Изображения/Лабораторная работа №4/19.png){ #fig:019 width=70% }

![](/home/narogozhina/Изображения/Лабораторная работа №4/20.png){ #fig:020 width=70% }

![](/home/narogozhina/Изображения/Лабораторная работа №4/21.png){ #fig:021 width=70% }

![](/home/narogozhina/Изображения/22.png){ #fig:022 width=70% }

![](/home/narogozhina/Изображения/23.png){ #fig:023 width=70% }
